...
public class MainUAS {
    ...
    public static void main(String[] args) {
        MahasiswaBaru maba = new MahasiswaBaru("Sofiullah Abi Sadzili", 19, 22205024);
        maba.displayInfo();

        MahasiswaLama mala = new MahasiswaLama("Sofiullah Abi ", 19, 2022);
        mala.displayInfo();
    }
}
